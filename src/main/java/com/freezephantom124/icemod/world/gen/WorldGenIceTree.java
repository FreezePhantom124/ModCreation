...
public class WorldGenIceTree extends WorldGenAbstractTree
{
	public static final IBlockState LOG = ModBlocks.ICE_LOG.getDefaultState();
	public static final IBlockState LEAVES = ModBlocks.ICE_LEAVES.getDefaultState();
	
	private int minHeight;
	
	public WorldGenIceTree()
	{
		super(false);
		this.minHeight = 9;
	}
