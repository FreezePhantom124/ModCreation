...
{
	public static final IBlockState LOG = ModBlocks.FIRE_LOG.getDefaultState();
	public static final IBlockState LEAVES = ModBlocks.FIRE_LEAVES.getDefaultState();
	
	private int minHeight;
	
	public WorldGenFireTree()
	{
		super(false);
		this.minHeight = 6;
	}
